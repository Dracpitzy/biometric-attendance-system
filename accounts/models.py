...
from staffs.models import Department, Staff
...
class AdminProfile(models.Model):
    ...
    department = models.ForeignKey(
        Department, on_delete=models.SET_NULL, null=True, blank=True, related_name="admin_profiles"
    )
    linked_staff = models.OneToOneField(
        Staff, on_delete=models.SET_NULL, null=True, blank=True, related_name="admin_profile"
    )
